...
describe("Item.component.vue", () => {
    it("renders an Item correctly", () => {
        ...
        // строка 'Unit test item 1', но это не очень правильно expect(wrapper.text()).to.include('Unit test item 1')
        // это более правильный подход: сначала находим нужный // элемент (div с классом `name`), а затем проверяем, // содержится ли в нём нужный текст
